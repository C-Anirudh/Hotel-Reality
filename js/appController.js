  ...
  function(ko, Context, moduleUtils, KnockoutTemplateUtils, CoreRouter, ModuleRouterAdapter, KnockoutRouterAdapter, UrlParamAdapter, ResponsiveUtils, ResponsiveKnockoutUtils, ArrayDataProvider, OffcanvasUtils) {
     ...
     function ControllerViewModel() {
      ...
      let navData = [
        ...
        { path: 'kpi', detail: { label: 'KPI', iconClass: 'oj-ux-ico-fire' } },
        { path: 'mascot', detail: { label: 'Mascot', iconClass: 'oj-ux-ico-contact-group' } },
      ...
      this.appName = ko.observable("Hotel Reality");
      // User Info used in Global Navigation area
      this.userLogin = ko.observable("team.mirage@oracle.com");
